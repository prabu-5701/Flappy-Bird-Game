...
PLAYERS = (
    (
        'assets/image/redbird-upflap.png',
        'assets/image/redbird-midflap.png',
        'assets/image/redbird-downflap.png',
    ),
    (
        'assets/image/bluebird-upflap.png',
        'assets/image/bluebird-midflap.png',
        'assets/image/bluebird-downflap.png',
    ),
    (
...
def main():
    ...
    IMAGES['numbers'] = (
        pygame.image.load('assets/image/0.png').convert_alpha(),
    ...
    IMAGES['gameover'] = pygame.image.load('assets/image/gameover.png').convert_alpha()
    
    IMAGES['message'] = pygame.image.load('assets/image/message.png').convert_alpha()
    
    IMAGES['base'] = pygame.image.load('assets/image/base.png').convert_alpha()
...
def showWelcomeAnimation():
    ...
    messagex = int((WIDTH- IMAGES['message'].get_width()) / 2)
...
def showScore(score):
    ...
    for digit in scoreDigits:
        SCREEN.blit(IMAGES['numbers'][digit], (Xoffset, HEIGHT * 0.1))
